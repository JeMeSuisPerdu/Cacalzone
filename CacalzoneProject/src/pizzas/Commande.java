...
public class Commande implements Serializable {
  ...
  public enum Etat {
    ...
    TRAITEE,
    /**
     * La commande est annulée et ne sera pas prise en compte pour les calculs
     * du ServiceClient.
     */
    ANNULEE
  }
   ...
   */
  public boolean ajouterPizza(Pizza pizza, int quantite)
  ...
  /**
   * Permet d'annuler la commande si elle n'est pas à l'état TRAITEE. Vide la
   * liste des pizzas de la commande actuelle. Met la commande à annuler (utile
   * pour les méthodes dans ServiceClient).
   */
  public void annuler() {
  ...
  /**
   * Getter qui renvoit un CompteClient.
   * 
  ...
  /**
   * Getter qui renvoit un Map qui associe une Pizza à une quantité de commande.
   * 
  ...
  /**
   * Getter qui renvoit la date de la commande dans un format adapté.
   * 
   * @return La date de création de la commande.
   */
