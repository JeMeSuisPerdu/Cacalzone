...
public class Pizza {
	...
	public void setPrix(Double prix) {
		if (prix>= this.prixMinimalPizza()) {
			...
			System.out.println(
					"ERREUR : Prix minimal Pizza doit-être supérieur ou égal à : " + this.prixMinimalPizza());
		}
	}
	...
	/**
	 * Méthode utilitaire qui permet de verifier si le prix d'une pizza correspond au minimum.
	 * Minimum : Somme des prix des ingrédients + 40 %.
	 * Le prix est ensuite arrondi au dixième de centimes.
	 * @param prix
	 * @return prix_Min
	 */
	public Double prixMinimalPizza() {
		...
		// (Prix : somme prix ingrédients + 40%) + conversion en centime grâce à *100
