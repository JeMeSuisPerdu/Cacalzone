 ...
 * 
 * <p>
 * Cette classe regroupe toutes les caractéristiques d'une pizza : son identité
 ...
 * (calcul de prix minimal, validation des ingrédients).
 * </p>
 */
public class Pizza implements Serializable {
	 ...
	 * 
	 * <p>
	 * Si un prix manuel a été défini (attribut non null), c'est celui-ci qui est
	 ...
	 * 
	 * <p>
	 * Une vérification est effectuée : le nouveau prix doit être supérieur ou égal
	 * au prix minimal (coût de revient + marge). Si le prix est trop bas, la
	 * modification est refusée.
	 * </p>
	 *
	 * @param prix Le prix souhaité.
	 * @return true si le prix a été mis à jour, false s'il est inférieur au minimum
	 *         autorisé.
	 */
	 ...
	 * 
	 * <p>
	 * La formule appliquée est la suivante : 1. Somme des prix unitaires de tous
	 * les ingrédients. 2. Ajout d'une marge de 40% (multiplication par 1.4). 3.
	 * Arrondi à la dizaine de centimes supérieure (ex: 12.11 devient 12.20).
	 * </p>
	 *
	 ...
	 * 
	 * <p>
	 * L'ajout n'est effectué que si deux conditions sont réunies : 1. L'ingrédient
	 ...
	 * de viande sur une végétarienne).
	 * </p>
	 *
